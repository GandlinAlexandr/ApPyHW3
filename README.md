...
<details>
  ...
  <ol>
    ...
    <li><a href="#основные-ручки-api">Основные ручки API</a></li>
        ...
        <ul><li><a href="#работа-со-ссылками">Работа со ссылками</a></li></ul>
        <ul><li><a href="#архив-и-история">Архив и история</a></li></ul>
        <ul><li><a href="#популярные-ссылки">Популярные ссылки</a></li></ul>
        <ul><li><a href="#проекты">Проекты</a></li></ul>
